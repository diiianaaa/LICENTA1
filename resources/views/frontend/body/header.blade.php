<header class="header-style-1">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand" img src="{{ asset('frontend/assets/images/banners/logo2.png') }}" href="{{ url('/dashboard') }}"></span></a>
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item"><a href="{{ url('/') }}" class="nav-link"> @if(session()->get('language') == 'german') Zuhause @else Home @endif</a></li>
