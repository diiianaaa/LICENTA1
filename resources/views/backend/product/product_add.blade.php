...
<div class="row"> <!-- start 2nd row  -->
			...
			<div class="controls">
				<input type="text" name="product_name_ger" class="form-control" required="">
...
<div class="row"> <!-- start 4th row  -->
	    ...
	    <div class="form-group">
			...
			<div class="controls">
	 <input type="text" name="product_tags_ger" class="form-control" value="" data-role="tagsinput" required="">
...
<div class="row"> <!-- start 7th row  -->
	...
	<textarea name="short_descp_en" id="textarea" class="form-control" required="" placeholder="Textarea text"></textarea>     
	     ...
	     <div class="form-group">
			...
			<div class="controls">
	<textarea name="short_descp_ger" id="textarea" class="form-control" required="" placeholder="Textarea text"></textarea>     
	 		 </div>
		</div>
